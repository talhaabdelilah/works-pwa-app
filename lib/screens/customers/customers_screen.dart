...
import 'package:project_manager/models/customer.dart';
import 'package:project_manager/models/project.dart';
import 'package:project_manager/screens/customers/customer_projects_screen.dart';
...
class _CustomersScreenState extends State<CustomersScreen> {
          ...
          content: Column(
            ...
            children: [
              NameSuggestionsField(
                controller: nameCtrl,
                existingNames: widget.userData.customers.map((c) => c.name).toList(),
                label: 'اسم العميل',
              ),
  ...
  void _editCustomer(Customer customer) {
    ...
    final locationCtrl = TextEditingController(text: customer.location);
    showDialog(
      context: context,
      builder: (ctx) => Directionality(
        textDirection: TextDirection.rtl,
