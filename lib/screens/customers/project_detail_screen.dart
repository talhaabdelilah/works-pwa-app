                    ...
                    SizedBox(
                      ...
                      child: TextField(
                        ...
                        onChanged: (_) {
                          ...
                          if (p != null && p != _project.globalPricePerMeter) {
                            setState(() {
                              _project.globalPricePerMeter = p;
                              for (final room in _project.rooms) {
              ...
              Container(
                ...
                child: Column(
                  ...
                  children: [
                    Row(
                      children: [
                        const Text('📊 ملخص المشروع', style: TextStyle(fontSize: 12, fontWeight: FontWeight.bold, color: Color(0xFF1E293B))),
                      ],
                    ),
                    ...
                    Row(
                      children: [
                        Text('📐 اجمالي المساحة:', style: TextStyle(fontSize: 10, color: const Color(0xFF1E293B))),
                        const Spacer(),
                    ...
                    Row(
                      children: [
                        const Text('💰 الدفعات المستلمة:', style: TextStyle(fontSize: 10, color: Color(0xFF1E293B))),
                        const Spacer(),
                  ...
                  children: [
                    ...
                    if (_project.payments.isEmpty)
                      const Padding(
                        ...
                        child: Text('لا توجد دفعات', style: TextStyle(fontSize: 11, color: Color(0xFF1E40AF))),
                      )
                    else ...[
